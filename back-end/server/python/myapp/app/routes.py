...
def download_file(user_id, filename, dir_name=None):
    if dir_name is None or dir_name == "":
        DIRETORIO = 'C:/Users/980189/Documents/Matheus/QueroQuero/QQTech tarefas/Bê á Bá - Final V1/Bê á Bá - Final V1/Bê á Bá/back-end/server/python/myapp/data/users'
        print("1")
    else:
...
def download_file_dir(user_id, filename, dir_name=None):
    ...
    if len(dir_name_striped) > 2:
        for i in dir_name_striped:
            ...
            dir = f'{dir}/{i}'
        print(dir)
        DIRETORIO = f'C:/Users/980189/Documents/Matheus/QueroQuero/QQTech tarefas/Bê á Bá - Final V1/Bê á Bá - Final V1/Bê á Bá/back-end/server/python/myapp/data/{dir}/users/{user_id}/files/{filename.split("/")[0]}'
    else: 
...
def direct_file_download():
    DIRETORIO = r'C:/Users/980189/Documents/Matheus/QueroQuero/QQTech tarefas/Bê á Bá - Final V1/Bê á Bá - Final V1/Bê á Bá/back-end/server/python/myapp/data/'
...
def get_dashboard_relatorios():
    DIRETORIO = 'C:/Users/980189/Documents/Matheus/QueroQuero/QQTech tarefas/Bê á Bá - Final V1/Bê á Bá - Final V1/Bê á Bá/back-end/server/python/myapp/relatorios'
    try:
        dashboard_data = DashboardService.genDashboardData()
